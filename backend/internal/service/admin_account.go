...
func (s *adminServiceImpl) BulkUpdateAccounts(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
	...
	var hasDeepSeekUserIsolationUpdate, hasDeepSeekWebSocketModeUpdate bool
	if input.Extra != nil {
	...
	if len(input.Credentials) > 0 || input.ProxyID != nil || needMixedChannelCheck || openAISettings.any() || hasDeepSeekExtraUpdate || input.ProbeEnabled != nil || input.RateMultiplier != nil {
