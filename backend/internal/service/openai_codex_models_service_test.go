...
func TestNewConfiguredCodexModelDescriptorUsesProviderMetadataAndSafeFallback(t *testing.T) {
	...
	require.Equal(t, "OpenAI GPT coding model routed through Sub2API.", gpt6Astra.Description)
	...
	require.Equal(t, configuredCodexTruncationPolicy{Mode: "tokens", Limit: 10_000}, gpt6Astra.TruncationPolicy)
	require.Equal(t, "none", gpt6Astra.DefaultReasoningSummary)
