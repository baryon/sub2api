...
func (s *OpenAIGatewayService) forwardOpenAIPassthrough(
	...
	for {
		...
		if reqStream {
			...
			// Non-streaming handlers commit the response before returning. Only
			// now may this account become the recorded origin of the state seen
			// by the client. Streaming records provenance at the write point.
