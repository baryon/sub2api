...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 63, "arg-type table must include request_kind, requested_reasoning_effort, upstream_request_id, session_id, and native_compaction_v2")
