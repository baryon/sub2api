...
//
// The input_tokens and compact checks MUST be evaluated before the root
// Responses check, otherwise "/v1/responses" (a prefix of both) would
// erroneously match first.
...
// isResponsesInputTokensAliasPath reports whether path is the bare/alias
// Codex token-count preflight, rooted at "/responses/input_tokens" or
