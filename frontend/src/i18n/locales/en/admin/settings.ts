export default {
    settings: {
      ...
      site: {
        ...
        homeContentPlaceholder: 'Enter custom content for the home page. Supports Markdown & HTML, and plain-text http(s) URLs become clickable links. If the entire value is a URL, it will be displayed as an iframe.',
        homeContentHint: 'Customize the home page content. Supports Markdown/HTML, and plain-text http(s) URLs become clickable links. If the entire value is a URL (starting with http:// or https://), it will be used as an iframe src to embed an external page. When set, the default status information will no longer be displayed.',
